...
Für die Aufbereitung und Auswertung der erfassten Fahrzeugdaten wird ein Backend bereitgestellt, in das die Daten hochgeladen werden können. Der folgende angebotene Funktionsumfang deckt dabei die in Kapitel \ref{sec:useCases} definierten Anforderungen ab\todo{@andi Referenz auf Use Cases einfügen, bzw. passt text ned ganz weil bei den use cases nicht des alles gefordert ist}:
