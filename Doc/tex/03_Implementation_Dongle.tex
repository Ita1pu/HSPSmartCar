...
\begin{figure}[h]
  ...
  \end{center}
\end{figure}
%% Wenig RAM -> nur eine Datei offen
%% Aufteilung der Funktionen
%% File_System hander bietet alle Funktionen zum erstellen und löschen von Dateien generell
%% Persitence bietet Funktionen zum Loggen der Daten wie zumbeispiel createLoggingEntry() oder openLoggingFile()
...
\begin{center}
  \begin{tabular}{ | c || c | c | c | c |}
    ...
    \hline
  \end{tabular}
  \caption{Format eines Logging Eintrags auf der SD-Karte}
